...
const App: React.FC = () => {
  ...
  const startConversation = async () => {
    ...
    if (!apiKey || apiKey === "undefined") return alert("API Key missing. Please check Netlify Environment Variables.");
    ...
    try {
      ...
      const session = await ai.live.connect({
        ...
        callbacks: { onopen: () => {}, onmessage: () => {}, onerror: () => {}, onclose: () => {} } // תיקון 117.png
      });
